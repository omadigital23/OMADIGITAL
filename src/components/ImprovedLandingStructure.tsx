...
function TrustSection() {
  ...
  return (
    <section 
      className="py-16 bg-gradient-to-r from-orange-50 via-white to-blue-50"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 id="trust-section-title" className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            {t('benefits.title')}
          </h2>
...
function WhyChooseUsSection() {
  ...
  return (
    ...
    >
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,theme(colors.orange.500),transparent_50%)] opacity-10" aria-hidden="true"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <h2 id="why-choose-us-title" className="text-4xl md:text-5xl font-bold mb-6">
            {t('benefits.title')}{' '}
