...
export function NewsletterSignup() {
  ...
  return (
    <div className="mt-8 md:mt-16 bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-4 md:p-8 text-center text-white shadow-2xl">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 md:gap-4 max-w-lg mx-auto">
        <div className="flex-1 relative">
          <input
            ...
            className="w-full px-4 md:px-5 py-3 md:py-4 rounded-xl text-gray-900 placeholder-gray-500 border-2 border-transparent focus:border-white focus:ring-2 focus:ring-white/20 transition-all text-sm md:text-base font-medium"
            required
        ...
        <button 
          type="submit"
          className="bg-white text-orange-600 px-6 md:px-8 py-3 md:py-4 rounded-xl font-black text-sm md:text-base hover:bg-gray-100 hover:scale-105 transition-all duration-300 disabled:opacity-75 flex items-center justify-center shadow-lg min-w-[120px] md:min-w-[140px]"
          disabled={isSubmitting}
        >
          {isSubmitting ? (
      ...
      {/* Garanties */}
      <div className="mt-4 md:mt-6 flex flex-wrap justify-center items-center gap-3 md:gap-6 text-xs md:text-sm opacity-90">
