...
const TrustMetrics = memo(() => {
  const metrics = [
    { value: "200+", label: "PME Transformées", icon: "🏢" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            💰 Comment 200+ PME ont Doublé leur CA
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            <strong>Résultats garantis en 90 jours</strong> - Découvrez pourquoi nos clients obtiennent +247% de CA en moyenne
          </p>
        </motion.div>
