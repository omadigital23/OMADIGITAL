      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-md md:max-w-lg w-full overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <button
            ...
            className="w-full border-2 border-gray-300 bg-white text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-50 disabled:bg-gray-100 font-semibold transition-all flex items-center justify-center gap-3"
          >
            {googleLoading ? (
            ...
            {googleLoading
              ? (t.processing || 'Traitement...')
              : (t.sign_in_with_google || 'Continuer avec Google')}
          </button>
