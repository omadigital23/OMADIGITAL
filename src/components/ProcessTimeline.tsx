  ...
  const steps = [
    {
      ...
      description: "Analyse complète de votre écosystème digital actuel, identification des opportunités et définition des objectifs.",
      deliverables: ["Audit technique complet", "Analyse concurrentielle", "Roadmap personnalisée"],
      color: "bg-blue-500"
    },
    {
      icon: Lightbulb,
      ...
      description: "Conception de la stratégie digitale, création du design et prototypage des solutions sur mesure.",
      deliverables: ["Stratégie digitale", "Maquettes design", "Architecture technique"],
      color: "bg-purple-500"
    },
    {
      icon: Code,
      ...
      description: "Développement des solutions avec méthodologie agile, tests continus et intégrations API.",
      deliverables: ["Code source", "Tests automatisés", "Intégrations API"],
      color: "bg-green-500"
    },
    {
      icon: Rocket,
      ...
      duration: "1 semaine",
      description: "Mise en production sécurisée, formation de vos équipes et migration des données existantes.",
      deliverables: ["Déploiement production", "Formation équipes", "Migration données"],
      color: "bg-orange-500"
    },
    {
      icon: BarChart3,
      ...
      duration: "Continue",
      description: "Monitoring des performances, optimisations basées sur les données et évolutions fonctionnelles.",
      deliverables: ["Dashboard analytics", "Rapports mensuels", "Optimisations continues"],
      color: "bg-red-500"
    },
    {
      icon: HeadphonesIcon,
      ...
      duration: "Permanent",
      description: "Support technique permanent, maintenance préventive et assistance pour vos équipes.",
      deliverables: ["Support technique", "Maintenance préventive", "Formations continues"],
      color: "bg-indigo-500"
    }
  ];
    ...
    <section id="process" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 bg-gradient-to-r from-gray-50 to-white rounded-2xl p-8 border border-gray-200">
          <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Pourquoi notre processus fonctionne</h3>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <CheckCircle className="w-8 h-8 text-blue-600" />
              </div>
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Transparence Totale</h4>
              <p className="text-gray-600">Accès en temps réel à l'avancement de votre projet avec des rapports détaillés.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <CheckCircle className="w-8 h-8 text-green-600" />
              </div>
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Agilité & Flexibilité</h4>
              <p className="text-gray-600">Adaptation continue selon vos besoins avec des itérations rapides.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <CheckCircle className="w-8 h-8 text-orange-600" />
              </div>
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Résultats Mesurables</h4>
              <p className="text-gray-600">KPIs clairs et rapports mensuels pour suivre votre transformation digitale.</p>
            </div>
          </div>
        </div>
