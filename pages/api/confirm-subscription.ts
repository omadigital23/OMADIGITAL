...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    // Find subscriber by confirmation token in blog_subscribers table
    ...
    try {
      await supabase.rpc('log_newsletter_event', {
        p_subscriber_email: subscriber.email,
        p_event_type: 'confirm',
        p_event_data: { confirmation_token: token },
        p_ip_address: req.headers['x-forwarded-for'] as string || req.connection.remoteAddress,
