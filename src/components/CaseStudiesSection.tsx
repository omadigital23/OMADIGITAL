  ...
  const caseStudies: CaseStudy[] = [
    {
      ...
      results: [
        { metric: t('case_studies.boulangerie.results.orders_processed'), value: t('case_studies.boulangerie.results.orders_value'), icon: TrendingUp },
        { metric: t('case_studies.boulangerie.results.customer_satisfaction'), value: t('case_studies.boulangerie.results.satisfaction_value'), icon: Star },
        { metric: t('case_studies.boulangerie.results.response_time'), value: t('case_studies.boulangerie.results.time_value'), icon: Clock },
        { metric: t('case_studies.boulangerie.results.monthly_revenue'), value: t('case_studies.boulangerie.results.revenue_value'), icon: Users }
      ],
    ...
    },
    {
      ...
      results: [
        { metric: t('case_studies.riad.results.direct_bookings'), value: t('case_studies.riad.results.bookings_value'), icon: TrendingUp },
        { metric: t('case_studies.riad.results.occupancy_rate'), value: t('case_studies.riad.results.occupancy_value'), icon: Star },
        { metric: t('case_studies.riad.results.revenue_per_room'), value: t('case_studies.riad.results.revenue_value'), icon: TrendingUp },
        { metric: t('case_studies.riad.results.five_star_reviews'), value: t('case_studies.riad.results.reviews_value'), icon: Users }
      ],
    ...
    },
    {
      ...
      results: [
        { metric: t('case_studies.pharmacie.results.stockouts_avoided'), value: t('case_studies.pharmacie.results.stockouts_value'), icon: TrendingUp },
        { metric: t('case_studies.pharmacie.results.loyal_patients'), value: t('case_studies.pharmacie.results.patients_value'), icon: Users },
        { metric: t('case_studies.pharmacie.results.over_the_counter_revenue'), value: t('case_studies.pharmacie.results.revenue_value'), icon: Star },
        { metric: t('case_studies.pharmacie.results.daily_deliveries'), value: t('case_studies.pharmacie.results.deliveries_value'), icon: Clock }
      ],
      image: "https://images.unsplash.com/photo-1631549916768-4119b2e5f926?w=600&h=400&fit=crop&crop=center&auto=format&q=75",
    ...
    },
    {
      ...
      results: [
        { metric: t('case_studies.atelier.results.international_sales'), value: t('case_studies.atelier.results.sales_value'), icon: TrendingUp },
        { metric: t('case_studies.atelier.results.production_time'), value: t('case_studies.atelier.results.time_value'), icon: Clock },
        { metric: t('case_studies.atelier.results.senegalese_diaspora'), value: t('case_studies.atelier.results.diaspora_value'), icon: Users },
        { metric: t('case_studies.atelier.results.average_basket'), value: t('case_studies.atelier.results.basket_value'), icon: Star }
      ],
      image: "https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=600&h=400&fit=crop&crop=center&auto=format&q=75",
