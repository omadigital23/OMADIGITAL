-- Complete OMA Digital Database Schema (Clean Version Without Blog Tables)
-- This file contains all the necessary tables for the OMA Digital platform without blog tables
