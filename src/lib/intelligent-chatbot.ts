...
- Contact: +212 70 119 38 11, omadigital23@gmail.com
  ...
  private getFallbackResponse(message: string, language: 'fr' | 'en'): string {
    ...
    if (language === 'fr') {
      switch (intent) {
        ...
        case 'services':
          return "OMA Digital propose :\n\n• Automatisation WhatsApp (50 000 CFA/mois)\n• Développement web et mobile\n• Transformation digitale PME\n• ROI garanti 200% en 6 mois\n\nContactez-nous : +212 70 119 38 11";
        
        case 'pricing':
          return "Nos tarifs démarrent à 50 000 CFA/mois pour l'automatisation WhatsApp avec ROI garanti de 200%. Devis gratuit personnalisé. Contactez-nous : +212 70 119 38 11";
      ...
      switch (intent) {
        ...
        case 'services':
          return "OMA Digital offers:\n\n• WhatsApp Automation (50,000 CFA/month)\n• Web and mobile development\n• Digital transformation for SMEs\n• Guaranteed 200% ROI in 6 months\n\nContact us: +212 70 119 38 11";
        
        case 'pricing':
          return "Our rates start at 50,000 CFA/month for WhatsApp automation with guaranteed 200% ROI. Free personalized quote. Contact us: +212 70 119 38 11";
