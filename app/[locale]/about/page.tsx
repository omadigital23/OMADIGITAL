    ...
    <main className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-blue-600 to-purple-700 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            {params.locale === 'fr' ? 'À Propos d\'OMA Digital' : 'About OMA Digital'}
          </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">
              {params.locale === 'fr' ? 'Notre Histoire' : 'Our Story'}
            </h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">
              {params.locale === 'fr' ? 'Notre Fondateur' : 'Our Founder'}
            </h2>
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold mb-2">Amadou Fall</h3>
                <p className="text-blue-600 font-semibold">
                  {params.locale === 'fr' ? 'Fondateur & CEO' : 'Founder & CEO'}
                </p>
              </div>
              <div className="prose prose-lg mx-auto">
                <p>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-4">
                    {params.locale === 'fr' ? 'Contact' : 'Contact'}
                  </h3>
