-- Complete OMA Digital Database Schema - Clean Version
-- This file contains all the necessary tables for the OMA Digital platform with proper ID relationships

-- Enable required extensions
CREATE EXTENSION IF NOT EXISTS vector;

-- 1. Core Authentication Tables (Supabase Auth)
-- Note: These tables are managed by Supabase Auth, but we reference them
...
COMMENT ON TABLE blog_articles IS 'Blog articles for the website';
...
COMMENT ON TABLE article_read_tracking IS 'Article reading behavior tracking';
