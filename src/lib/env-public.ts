...
export const NEXT_PUBLIC_SUPABASE_URL = requireEnv(
  ...
  // Common local Supabase URL; adjust to your setup or set in .env.local
...
export const NEXT_PUBLIC_SUPABASE_ANON_KEY = requireEnv(
  ...
  // Development-only placeholder; real projects should set the real anon key in .env.local
  'dev-anon-key'
);
