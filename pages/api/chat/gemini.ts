...
const SUGGESTIONS = {
  en: {
    ...
    default: ['Discover all services', 'Request free consultation', 'Contact us by email']
  },
  fr: {
    ...
    default: ['Découvrir tous les services', 'Demander consultation gratuite', 'Nous contacter par email']
  }
} as const;
