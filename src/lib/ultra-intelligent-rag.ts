...
import { vertexAIService } from './vertex-ai-service'; // Use Vertex AI service directly
...
class UltraIntelligentRAG {
  ...
  /**
   * Détection de langue ultra-précise avec intégration Google Cloud Vertex AI
   * Utilise exclusivement l'API Vertex AI pour la détection de langue
   */
  private async detectLanguageAdvanced(text: string): Promise<'fr' | 'en'> {
    ...
    try {
      ...
      console.error('Language detection error, defaulting to French:', error);
      return 'fr'; // Default to French for Senegalese market
    }
  }
  ...
  private async detectLanguageWithGoogleAPI(text: string): Promise<'fr' | 'en'> {
    // Directly use the advanced detection method
    return await this.detectLanguageAdvanced(text);
  }
...
📧 **omadigital23@gmail.com** ou appelle le 📱 **+212 701 193 811**
...
📧 **omadigital23@gmail.com** or call 📱 **+212 701 193 811**
...
📧 **Email:** omadigital23@gmail.com`;
  ...
  private generateContextualResponse(intent: string, language: 'fr' | 'en', entities: string[]): string {
    ...
    if (intent === 'contact_email_specific') {
      return language === 'fr' ? 'omadigital23@gmail.com' : 'omadigital23@gmail.com';
    }
...
📧 **Or by email:** omadigital23@gmail.com`,
...
📧 **Ou par email :**omadigital23@gmail.com`
      },
      pricing: {
  ...
  private generateSmartCTA(intent: string, language: 'fr' | 'en'): { type: 'contact' | 'demo' | 'appointment' | 'quote'; action: string; data?: any } {
    const ctas: Record<string, { type: 'contact' | 'demo' | 'appointment' | 'quote'; action: string; data?: any }> = {
      contact_email: {
        ...
        data: { email: 'omadigital23@gmail.com', subject: language === 'fr' ? 'Demande d\'information' : 'Information request' }
      },
      contact_phone: {
        type: 'contact',
      ...
      contact_general: {
        ...
        data: { phone: '+212701193811', email: 'omadigital23@gmail.com' }
      },
      demo_request: {
        type: 'demo',
...
const SIMULATED_KNOWLEDGE_BASE = [
  {
    ...
    content: 'Email: omadigital23@gmail.com. Phone: +212701193811. WhatsApp: +212701193811. Business hours: Monday-Friday 8am-6pm, Saturday 9am-1pm. WhatsApp support available 24/7. Response time: Within 2 hours on business days. Address: Liberté 6, Dakar, Senegal.',
    category: 'contact',
    language: 'en',
    keywords: ['email', 'phone', 'contact', 'omadigital23@gmail.com', '+212701193811', 'whatsapp', 'business hours', 'address', 'dakar', 'senegal'],
    is_active: true,
  ...
  },
  {
    ...
    content: 'Email : omadigital23@gmail.com. Téléphone : +212701193811. WhatsApp : +212701193811. Horaires : Lundi-Vendredi 8h-18h, Samedi 9h-13h. Support WhatsApp disponible 24/7. Temps de réponse : Sous 2 heures en semaine. Adresse : Liberté 6, Dakar, Sénégal.',
    category: 'contact',
    language: 'fr',
    keywords: ['email', 'téléphone', 'contact', 'omadigital23@gmail.com', '+212701193811', 'whatsapp', 'horaires', 'adresse', 'dakar', 'sénégal'],
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  },
