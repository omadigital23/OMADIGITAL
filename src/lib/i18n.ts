// This file is deprecated - using next-i18next configuration instead
// All translations are now handled by next-i18next with proper SSR support
...
const frTranslations = {
  translation: {
    ...
    'footer.senegalese_law_compliant': 'Conformité avec la Loi Sénégalaise',
    'footer.cnra_registration': 'Inscrit auprès de la CNRA',
    ...
    'blog.title': 'Blog OMA DIGITAL',
    'blog.subtitle': 'Astuces et Solutions pour PME',
    'blog.description': 'Doublez votre CA en 90 jours avec nos stratégies éprouvées. 200+ PME transformées au Sénégal et Maroc.',
    'blog.cta_button': '🚀 JE VEUX DOUBLER MON CA',
    ...
    'blog.stats': {
      'ca_increase': 'CA moyen en 90 jours',
      'pme_transformed': 'PME Transformées',
      'setup_time': 'Setup complet'
    },
    'blog.no_articles': 'Aucun article trouvé pour votre recherche.',
...
'footer.back_to_top': 'Back to top',
    ...
    'blog.title': 'OMA DIGITAL Blog',
    'blog.subtitle': 'Tips and Solutions for SMEs',
    'blog.description': 'Double your revenue in 90 days with our proven strategies. 200+ SMEs transformed in Senegal and Morocco.',
    'blog.cta_button': '🚀 I WANT TO DOUBLE MY REVENUE',
    ...
    'blog.stats': {
      'ca_increase': 'Average revenue in 90 days',
      'pme_transformed': 'SMEs Transformed',
      'setup_time': 'Complete setup'
    },
    'blog.no_articles': 'No articles found for your search.',
...
const translations: Translations = {
  ...
  'chatbot.sessionstable.user': {
    fr: 'Utilisateur',
    en: 'User'
  },
  'chatbot.sessionstable.date': {
    fr: 'Date',
    en: 'Date'
  },
  'chatbot.sessionstable.status': {
    fr: 'Statut',
    en: 'Status'
  },
  'chatbot.sessionstable.type': {
    fr: 'Type',
    en: 'Type'
  },
  'chatbot.sessionstable.messages': {
    fr: 'Messages',
    en: 'Messages'
  },
  'chatbot.sessionstable.lastMessage': {
    fr: 'Dernier message',
    en: 'Last message'
  },
  'chatbot.sessionstable.actions': {
    fr: 'Actions',
    en: 'Actions'
  },
  'chatbot.sessionstable.status.active': {
    fr: 'Active',
    en: 'Active'
  },
  'chatbot.sessionstable.status.completed': {
    fr: 'Terminée',
    en: 'Completed'
  },
  'chatbot.sessionstable.status.pending': {
    fr: 'En attente',
    en: 'Pending'
  },
  'chatbot.sessionstable.type.support': {
    fr: 'Support',
    en: 'Support'
  },
  'chatbot.sessionstable.type.sales': {
    fr: 'Vente',
    en: 'Sales'
  },
  'chatbot.sessionstable.type.general': {
    fr: 'Général',
    en: 'General'
  },
  ...
  'chatbot.sessionstable.actions.view': {
    fr: 'Voir les détails',
    en: 'View details'
  },
  'chatbot.sessionstable.actions.more': {
    fr: 'Plus d\'options',
    en: 'More options'
  },
  'chatbot.sessionstable.status.new': {
    fr: 'Nouvelle',
    en: 'New'
  },
  'chatbot.sessionstable.status.in_progress': {
    fr: 'En cours',
    en: 'In progress'
  },
  'chatbot.sessionstable.statusarchived': {
    fr: 'Archivée',
    en: 'Archived'
  },
  'chatbot.sessionstable.type.inquiry': {
    fr: 'Demande',
    en: 'Inquiry'
  },
  'chatbot.sessionstable.type.complaint': {
    fr: 'Réclamation',
    en: 'Complaint'
  },
  'chatbot.sessionstable.type.feedback': {
    fr: 'Retour',
    en: 'Feedback'
  }
};
...
// Legacy i18n configuration removed - using next-i18next instead
// All translations are now in /public/locales/ and handled by next-i18next