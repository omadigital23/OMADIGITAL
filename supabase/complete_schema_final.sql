-- Complete OMA Digital Database Schema - No Blog Version
-- This file contains all the necessary tables for the OMA Digital platform with blog tables removed
