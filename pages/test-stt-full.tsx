/**
 * Full test page for STT functionality with real audio recording
 */

import { useState, useRef } from 'react';
import { STTService } from '../src/lib/apis/stt-service';

export default function TestSTTFullPage() {
    ...
    try {
      ...
      mediaRecorder.onstop = async () => {
        ...
        try {
          ...
          setStatus(`Audio recorded. Size: ${audioBlob.size} bytes. Sending to STT service...`);
          
          // Use the actual STT service
          const result = await sttServiceRef.current.transcribe(audioBlob);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
        <h1 className="text-2xl font-bold text-center text-gray-800 mb-6">Full STT Test Page</h1>
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-md">
          ...
          <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
            ...
            <li>The audio will be sent to the HuggingFace STT service</li>
