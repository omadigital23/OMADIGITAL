...
export function HeroSection() {
  ...
  const slides = [
    ...
    },
    {
      ...
      stats: [
        { label: "Projets réussis", value: "300+" },
        { label: "ROI moyen", value: "+200%" },
    ...
    },
    {
      ...
      stats: [
        { label: "Brevets déposés", value: "12" },
        { label: "Partenaires tech", value: "25+" },
        { label: "R&D budget", value: "30%" }
      ]
    }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-8rem)]">
          ...
          >
            ...
            >
              ...
              #1 Transformation Digitale au Sénégal et Maroc
            </motion.div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                >
                  <span>{ctaVariant === 'A' ? currentSlideData.cta : 'Transformer Mon Business'}</span>
